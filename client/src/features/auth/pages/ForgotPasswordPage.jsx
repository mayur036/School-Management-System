          ...
          <div className="mx-auto w-full max-w-95 space-y-6">
            {!isSent ? (
              ...
              <div className="space-y-6 text-center">
                ...
                <div className="bg-muted/30 border-border text-muted-foreground rounded-xl border p-4 text-left text-xs leading-normal">
                  <strong>Didn't receive the email?</strong>
                  <ul className="mt-1 list-disc space-y-1 pl-4">
                    <li>Check your spam or junk folder.</li>
                    <li>Verify that the email entered is correct.</li>
                ...
                <div className="space-y-3 pt-2">
                  <Button
                    ...
                    className="border-border hover:bg-muted/35 bg-background flex h-11 w-full cursor-pointer items-center justify-center rounded-xl font-semibold"
                  >
                    Try another email
                  </Button>
                  ...
                  <button
                    type="button"
                    onClick={() => navigate('/login')}
                    className="text-primary w-full cursor-pointer text-center text-xs font-medium hover:underline"
                  >
                    Back to sign in page
                  </button>
                </div>
